...
<html>
  <head>
    <title>Eliminar Noticias PlayStation</title>
  ...
  <body>
   <div class="cuerpo">
        ...
        <div class="cabezera">PlayStation</div>
    	<?php 
        ...
        <?php 
                ...
                print "<a class=\"btn btn-primary\" href=\"eliminar_play.php?id=$valor[id]\">Eliminar Noticia</a>";
        ?>      
