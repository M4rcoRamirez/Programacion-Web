  ...
  <body>
    <div class="cuerpo">
      ...
      <div class="acciones">
          ...
          <?php
          $consulta = "UPDATE noticias_xbox SET titulo = '$titulo', autor = '$autor', descripcion = '$descripcion', cuerpo_noticia = '$cuerpo_noticia' WHERE id = $id";
            ...
            <div class="IngresaNuevaPregunta">
            <a href=modificar_xbox.php> Modificar mas noticias</a>
            </div>
